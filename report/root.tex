...
\begin{figure}[H]
	\centering
	\subfigure[u(k)]{\includegraphics[width=0.7\linewidth]{figures/input}}
	\subfigure[y(k) vs r(k)]{\includegraphics[width=0.7\linewidth]{figures/output}}
	\subfigure[y(k) vs r(k)]{\includegraphics[width=0.7\linewidth]{figures/ts}}
...
\begin{figure}[H]
	\centering
	\subfigure[States vs step (k)]{\includegraphics[width=0.7\linewidth]{figures/states}}
	\subfigure[x1(k) vs x2(k)]{\includegraphics[width=0.7\linewidth]{figures/phaseplot_x1x2}}
	\subfigure[x1(k) vs x3(k)]{\includegraphics[width=0.7\linewidth]{figures/phaseplot_x1x3}}
	\subfigure[x2 (k) vs x3(k)]{\includegraphics[width=0.7\linewidth]{figures/phaseplot_x2x3}}
